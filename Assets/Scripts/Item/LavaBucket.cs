...
[CreateAssetMenu(fileName = "LavaBucket", menuName = "Scriptable Objects/LavaBucket")]
public class LavaBucketItem : BlockItem
{
...
#if UNITY_EDITOR
[CustomEditor(typeof(LavaBucketItem))]
class LavaBucketItemEditor : Editor
{
